...
//        ],
        ...
        'sender_mobile' => [
            'mobile' => 'فرمت شماره همراه معتبر نیست.',
        ],
        'receiver_mobile' => [
            'mobile' => 'فرمت شماره همراه معتبر نیست.',
        ],
        'marketer_id' => [
            'marketer' => 'یک بازاریاب انتخاب نمایید',
        ],
        'customer_id' => [
            'customer' => 'یک مشتری انتخاب نمایید',
        ],
        '*' => [
    ...
    */
    ...
    'attributes' => [
        ...
        'billing_province' => 'استان',
        'billing_city' => 'شهر',
        'billing_zip_code' => 'کدپستی',
        'billing_address' => 'آدرس',
        'billing_latitude' => 'عرض جغرافیایی',
        'billing_longitude' => 'طول جغرافیایی',

        'shipping_country' => 'کشور',
        'shipping_province' => 'استان',
        'shipping_city' => 'شهر',
        'shipping_zip_code' => 'کدپستی',
        'shipping_address' => 'آدرس',
        'shipping_latitude' => 'عرض جغرافیایی',
        'shipping_longitude' => 'طول جغرافیایی',
        'currency_id.*' => 'نوع ارز',
        'description.*' => 'توضیحات',
        'currency_rate.*' => 'نرخ ارز',
        'currency_price.*' => 'قیمت ارز',
        'amount.*' => 'مبلغ',

        'sender_name' => 'نام',
        'sender_country' => 'کشور',
        'sender_province' => 'استان',
        'sender_city' => 'شهر',
        'sender_email' => 'ایمیل',
        'sender_phone' => 'تلفن',
        'sender_mobile' => 'شماره همراه',
        'sender_fax' => 'فکس',
        'sender_zip_code' => 'کد پستی',
        'sender_address' => 'آدرس',

        'receiver_name' => 'نام',
        'receiver_country' => 'کشور',
        'receiver_province' => 'استان',
        'receiver_city' => 'شهر',
        'receiver_email' => 'ایمیل',
        'receiver_phone' => 'تلفن',
        'receiver_mobile' => 'شماره همراه',
        'receiver_fax' => 'فکس',
        'receiver_zip_code' => 'کد پستی',
